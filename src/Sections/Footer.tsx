...
const Socials = [
    { icon: "ri:facebook-fill", url: "https://m.facebook.com/particle.bd" },
            ...
            <Container className="bg-[radial-gradient(farthest-corner,_transparent,_white),url('/images/net.png')] py-10">
                <div className="grid grid-cols-12 gap-2 items-center mb-5">
                    <div className="col-span-9 msm:col-span-9 xxs:col-span-12">
                        <Image src="/images/logos.png" alt="Logo" width={312} height={232} className="w-40" />
                ...
                <div className="flex gap-2 flex-wrap items-center">
                    <div className="xxs:max-msm:basis-[100%] xxs:max-msm:text-center xxs:max-msm:mb-3">
                        <p className="text-base opacity-60">© {new Date().getFullYear()} <Link href="https://particlebd.com/" target="_blank">Particle Academy</Link>. All rights reserved.</p>
                    </div>
