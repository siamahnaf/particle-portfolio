        ...
        <section id="notice">
            <Container className="py-8">
                <div className="text-center">
                    ...
                    <p className="w-[60%] mx-auto mt-2">Welcome to the particle notice board! This is the go-to destination for all important announcements and information regarding the particle community.</p>
                </div>
                <p className="text-center text-main mt-8 font-medium">We are coming soon online notice board! Wait & Explore!</p>
